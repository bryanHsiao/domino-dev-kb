...
| 2026-07-16 | [DQL「Domino Query 執行時錯誤」診斷階梯與 design catalog](cases/2026-07-16-dql-4854-diagnostic-ladder.md) | 錯誤訊息分三層各有解法（程式端錯誤碼一律 4854）；view 設計變更後 `updall -d` 可能損毀 catalog 造成行為不一致；0 筆無錯誤時照檢查清單排查 |
